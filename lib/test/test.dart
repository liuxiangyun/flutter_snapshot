...
class Test {
  static List<Video> builderData() {
    ...
    video.id = 1000;
    video.cover =
        "https://ss1.bdstatic.com/70cFuXSh_Q1YnxGkpoWK1HF6hhy/it/u=3487984255,3327670184&fm=26&gp=0.jpg";
    ...
    video1.id = 2356;
    video1.cover =
        "https://ss1.bdstatic.com/70cFuXSh_Q1YnxGkpoWK1HF6hhy/it/u=2434266276,772179149&fm=26&gp=0.jpg";
    ...
    video3.id = 5679;
    video3.cover =
        "https://ss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=3573990535,3119807631&fm=26&gp=0.jpg";
    ...
    video5.id = 3658;
    video5.cover =
        "https://ss1.bdstatic.com/70cFuXSh_Q1YnxGkpoWK1HF6hhy/it/u=4152062813,2671400290&fm=26&gp=0.jpg";
